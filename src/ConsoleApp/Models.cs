...
namespace TwitchOverlayConsoleAppCore
{
    ...
    public class WarStats
    {
        ...
        public void Process(War war, int p)
        {
            try
            {
                thirteenLeft = war.clans.First(c => c.tag == ClanTag).member.Where(a => a.townhallLevel == 13).Count() * 2;
                ...
                thirteenLeftE = war.clans.First(c => c.tag != ClanTag).member.Where(a => a.townhallLevel == 13).Count() * 2;
                ...
                thirteens = war.clans.First(c => c.tag == ClanTag).member.Where(a => a.townhallLevel == 13).Count();
                thirteensE = war.clans.First(c => c.tag != ClanTag).member.Where(a => a.townhallLevel == 13).Count();
                ...
                foreach (Members friend in war.clans.First(c => c.tag == ClanTag).member)
                {
                    ...
                    foreach (stats a in (enemyAttacks ?? new List<stats>()).Where(a => a.defenderTag == friend.tag).OrderByDescending(a => a.stars).ThenByDescending(a => a.destructionPercentage))
                    {
                        if (!found)
                        {
                            ...
                            if (friend.townhallLevel == 13 && a.stars == 3) { thirteenThreeE += 1; }
                            if (friend.townhallLevel == 13 && a.stars == 2) { thirteenTwoE += 1; }
                        ...
                        attacksE += 1;
                        if (friend.townhallLevel == 13 && a.enemyTH == 13)
                        {
                            thirteenV13TE += 1;
                            if (a.stars == 3) { thirteenV13E += 1; }
                        }
                        if (friend.townhallLevel == 12 && a.enemyTH == 13)
                        {//dip
                            thirteenV12TE += 1;
                            if (a.stars == 3) { thirteenV12E += 1; }
                        }
                        if (friend.townhallLevel == 13 && a.enemyTH == 12)
                        {//hitup
                            twelveV13TE += 1;
                            if (a.stars == 2) { twelveV13E += 1; }
                        }
                ...
                if (thirteenV13TE == 0)
                {
                    thirteenV13PE = Math.Round((decimal) 0, p);
                }
                else
                {
                    thirteenV13PE = Math.Round((decimal) thirteenV13E / (decimal) thirteenV13TE * 100, p);
                }
                ...
                if (thirteenV12TE == 0)
                {
                    thirteenV12PE = Math.Round((decimal) 0, p);
                }
                else
                {
                    thirteenV12PE = Math.Round((decimal) thirteenV12E / (decimal) thirteenV12TE * 100, p);
                }
                ...
                if (twelveV13TE == 0)
                {
                    twelveV13PE = Math.Round((decimal) 0, p);
                }
                else
                {
                    twelveV13PE = Math.Round((decimal) twelveV13E / (decimal) twelveV13TE * 100, p);
                }
                ...
                foreach (Members enemy in war.clans.First(c => c.tag != ClanTag).member)
                {
                    ...
                    foreach (stats a in (friendAttacks ?? new List<stats>()).Where(a => a.defenderTag == enemy.tag).OrderByDescending(a => a.stars).ThenByDescending(a => a.destructionPercentage))
                    {
                        if (!found)
                        {
                            ...
                            if (enemy.townhallLevel == 13 && a.stars == 3) { thirteenThree += 1; }
                            if (enemy.townhallLevel == 13 && a.stars == 2) { thirteenTwo += 1; }
                            if (enemy.townhallLevel == 12 && a.stars == 3) { twelveThree += 1; }
                            if (enemy.townhallLevel == 12 && a.stars == 2) { twelveTwo += 1; }
                        ...
                        attacks += 1;
                        if (enemy.townhallLevel == 13 && a.friendlyTH == 13)
                        {
                            thirteenV13T += 1;
                            if (a.stars == 3) { thirteenV13 += 1; }
                        }
                        if (enemy.townhallLevel == 12 && a.friendlyTH == 13)
                        {//dip
                            thirteenV12T += 1;
                            if (a.stars == 3){ thirteenV12 += 1; }
                        }
                        if (enemy.townhallLevel == 13 && a.friendlyTH == 12)
                        {//hitup
                            twelveV13T += 1;
                            if (a.stars == 3) { twelveV13 += 1; }
                        }
                ...
                if (thirteenV13T == 0)
                {
                    thirteenV13P = Math.Round((decimal) 0, p);
                }
                else
                {
                    thirteenV13P = Math.Round((decimal) thirteenV13 / (decimal) thirteenV13T * 100, p);
                }
                if (thirteenV12T == 0)
                {
                    thirteenV12P = Math.Round((decimal) 0, p);
                }
                else
                {
                    thirteenV12P = Math.Round((decimal) thirteenV12 / (decimal) thirteenV12T * 100, p);
                }
                if (twelveV13T == 0)
                {
                    twelveV13P = Math.Round((decimal) 0, p);
                }
                else
                {
                    twelveV13P = Math.Round((decimal) twelveV13 / (decimal) twelveV13T * 100, p);
                }
        ...
        public int thirteenLeft { get; set; }
        ...
        public int thirteenLeftE { get; set; }
        ...
        public int thirteens { get; set; }
        public int thirteensE { get; set; }



        public int thirteenThree { get; set; }
        public int thirteenThreeE { get; set; }
        public int thirteenTwo { get; set; }
        public int thirteenTwoE { get; set; }
        ...
        public int thirteenV13 { get; set; }
        public int thirteenV13T { get; set; }
        public decimal thirteenV13P { get; set; }
        public int thirteenV13E { get; set; }
        public int thirteenV13TE { get; set; }
        public decimal thirteenV13PE { get; set; }

        public int thirteenV12 { get; set; }
        public int thirteenV12T { get; set; }
        public decimal thirteenV12P { get; set; }
        public int thirteenV12E { get; set; }
        public int thirteenV12TE { get; set; }
        public decimal thirteenV12PE { get; set; }

        public int twelveV13 { get; set; }
        public int twelveV13T { get; set; }
        public decimal twelveV13P { get; set; }
        public int twelveV13E { get; set; }
        public int twelveV13TE { get; set; }
        public decimal twelveV13PE { get; set; }
